...
figma:
  ...
  nodeId: '882:5830'
  componentKey: '4e91e4c5c21271e521b33d8040b72696f57837bf'
  name: '<MegaMenu>'
status: stable
updated: '2026-06-22'
---
...
Компонент соответствует Figma-компоненту `<MegaMenu>` (nodeId `882:5830`) из библиотеки UI Kit (DS) v2.0. В отличие от `Menubar` (горизонтальное меню без многоколоночных панелей) и `TieredMenu` (каскадное меню по уровням без колонок), `MegaMenu` предназначен для верхней навигации с большим числом сгруппированных разделов.
