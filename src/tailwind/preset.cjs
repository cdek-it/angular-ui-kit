    ...
    "extend": {
      "colors": {
        "primary": {
          ...
          "900": "#0e4514",
          "950": "#0c3b11",
          "DEFAULT": "var(--p-primary-color, #44e858)"
        },
        "on-primary": "var(--p-primary-contrast-color, #ffffff)",
        "surface-ground": "var(--p-content-background, #ffffff)",
        "surface-section": "var(--p-content-hover-background, #f0f0f1)",
        "surface-card": "var(--p-content-background, #ffffff)",
        "surface-overlay": "var(--p-overlay-background, #ffffff)",
        "surface-border": "var(--p-content-border-color, #e2e2e4)",
        "surface-hover": "var(--p-content-hover-background, #f0f0f1)",
        "color": "var(--p-text-color, #2b2e33)",
        "color-muted": "var(--p-text-muted-color, #85888e)",
        "color-secondary": "var(--p-text-secondary-color, #6d7076)",
        "danger": {
          "50": "#fffafa",
          "100": "#fff0f0",
          "200": "#fed4d4",
        ...
        "surface": {
          ...
          "900": "#2b2e33",
          "950": "#181a1f",
          "DEFAULT": "var(--p-content-background, #ffffff)"
        },
        "slate": {
          "50": "#f8fafc",
          "100": "#f1f5f9",
