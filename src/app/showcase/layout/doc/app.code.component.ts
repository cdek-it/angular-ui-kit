        ...
        <div *ngIf="code" class="doc-section-code">
            <div class="doc-section-code-buttons scalein animation-duration-300">
                <ng-container *ngIf="fullCodeVisible">
                    <button *ngIf="code.html" (click)="changeLang('html')" class="py-0 px-2 border-round !h-2" [ngClass]="{ 'code-active': lang === 'html' }"><span>HTML</span></button>
                    <button *ngIf="code.typescript" (click)="changeLang('typescript')" class="py-0 px-2 border-round !h-2" [ngClass]="{ 'code-active': lang === 'typescript' }"><span>TS</span></button>
                    <button *ngIf="code.scss" (click)="changeLang('scss')" class="py-0 px-2 border-round !h-2" [ngClass]="{ 'code-active': lang === 'scss' }"><span>SCSS</span></button>
                    ...
                    <button
                        *ngIf="code.data"
                        ...
                        class="!h-2 !w-2 p-0 inline-flex items-center justify-center"
                        [ngClass]="{ 'doc-section-code-active text-primary': lang === 'data' }"
                    >
                        <i class="pi pi-database"></i>
                    </button>
                </ng-container>
                <button *ngIf="!hideToggleCode" pTooltip="Toggle Full Code" tooltipStyleClass="doc-section-code-tooltip" tooltipPosition="bottom" class="!h-2 !w-2 p-0 inline-flex items-center justify-center" (click)="toggleCode()">
                ...
                <button type="button" class="!h-2 !w-2 p-0 inline-flex items-center justify-center" (click)="copyCode()" pTooltip="Copy Code" tooltipPosition="bottom" tooltipStyleClass="doc-section-code-tooltip">
