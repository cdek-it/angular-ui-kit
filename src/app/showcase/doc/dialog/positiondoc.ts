        ...
        <div class="card flex flex-col items-center gap-2">
            ...
            <p-dialog header="Edit Profile" [modal]="true" [(visible)]="visible" [position]="position" [style]="{ width: '25rem' }">
                ...
                <div class="flex items-center gap-3 mb-3">
                    <label for="username" class="font-semibold !w-6">Username</label>
                    <input pInputText id="username" class="flex-auto" autocomplete="off" />
                </div>
                <div class="flex items-center gap-3 mb-5">
                    <label for="email" class="font-semibold !w-6">Email</label>
...
<p-dialog
    ...
    [style]="{ width: '25rem' }">
        ...
        <div class="flex items-center gap-3 mb-3">
            <label for="username" class="font-semibold !w-6">
                Username
            </label>
            <input pInputText id="username" class="flex-auto" autocomplete="off" />
        </div>
        <div class="flex items-center gap-3 mb-5">
            <label for="email" class="font-semibold !w-6">
                Email
            </label>
            <input pInputText id="email" class="flex-auto" autocomplete="off" />
        </div>
