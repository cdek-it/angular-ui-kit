            ...
            <p-panelMenu [model]="items" styleClass="w-full md:!w-20">
                <ng-template pTemplate="item" let-item>
                    <a pRipple class="flex items-center px-3 py-2 cursor-pointer">
                        <i class="p-menuitem-icon" [class]="item.icon + ' text-primary'"></i>
                        <span class="p-menuitem-text ml-2">{{ item.label }}</span>
                        <p-badge *ngIf="item.badge" class="ml-auto" [value]="item.badge" />
                        <span *ngIf="item.shortcut" class="p-menuitem-text ml-auto border-1 surface-border border-round surface-100 text-xs p-1">{{ item.shortcut }}</span>
                    </a>
                </ng-template>
            </p-panelMenu>
        </div>
...
export class TemplateDoc implements OnInit {
    ...
    <ng-template pTemplate="item" let-item>
        <a pRipple class="flex items-center px-3 py-2 cursor-pointer">
            <i class="p-menuitem-icon" [class]="item.icon + ' text-primary'"></i>
            <span class="p-menuitem-text ml-2">
                {{ item.label }}
            </span>
            <p-badge *ngIf="item.badge" class="ml-auto" [value]="item.badge" />
            <span *ngIf="item.shortcut" class="p-menuitem-text ml-auto border-1 surface-border
