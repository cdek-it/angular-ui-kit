...
import { ModalDoc } from '@doc/sidebar/modaldoc';
...
@NgModule({
    ...
    declarations: [BasicDoc, TemplateDoc, ImportDoc, StyleDoc, PositionDoc, FullScreenDoc, SizeDoc, AccessibilityDoc, HeadlessDoc, ModalDoc],
