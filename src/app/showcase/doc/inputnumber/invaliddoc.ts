...
@Component({
    ...
    template: `
        <app-docsectiontext>
            <p>Invalid state style is added using the <i>ng-invalid</i> and <i>ng-touched</i> class to indicate a failed validation.</p>
        </app-docsectiontext>
        <div class="card flex justify-center">
            <p-inputNumber inputId="integeronly" class="ng-invalid ng-touched" [(ngModel)]="value1" />
        </div>
