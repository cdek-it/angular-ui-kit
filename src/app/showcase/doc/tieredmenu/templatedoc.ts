            ...
            <p-tieredMenu [model]="items">
                <ng-template pTemplate="item" let-item let-hasSubmenu="hasSubmenu">
                    <a pRipple class="flex items-center p-menuitem-link">
                        ...
                        <i *ngIf="hasSubmenu" class="p-submenu-icon pi pi-angle-right ml-auto text-primary"></i>
                    </a>
                </ng-template>
            </p-tieredMenu>
        </div>
...
export class TemplateDoc implements OnInit {
    ...
    <span [class]="item.icon" class="p-menuitem-icon"></span>
            <span class="p-menuitem-text ml-2">{{ item.label }}</span>
            <p-badge *ngIf="item.badge" class="ml-auto" [value]="item.badge" />
            <span *ngIf="item.shortcut" class="p-menuitem-text ml-auto border-1 surface-border border-round surface-100 text-xs p-1">
                {{ item.shortcut }}
            </span>
            <i *ngIf="hasSubmenu" class="p-submenu-icon pi pi-angle-right ml-auto text-primary"></i>
        </a>
