...
@Component({
    ...
    template: `
        ...
        <div class="card flex justify-center">
            <p-toggleButton disabled="true" onIcon="pi pi-check" offIcon="pi pi-times" [(ngModel)]="checked" onLabel="Yes" offLabel="No" styleClass="w-full sm:!w-10" ariaLabel="Confirmation" />
        </div>
