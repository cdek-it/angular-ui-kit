...
@Component({
    ...
    template: `
        ...
        <div class="card flex justify-center">
            <p-toggleButton [(ngModel)]="checked" onLabel="Locked" offLabel="Unlocked" onIcon="pi pi-check" offIcon="pi pi-times" onIcon="pi pi-lock" offIcon="pi pi-lock-open" styleClass="!w-9" ariaLabel="Do you confirm" />
        </div>
