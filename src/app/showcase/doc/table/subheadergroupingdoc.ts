                ...
                <p-table [value]="customers" sortField="representative.name" sortMode="single" [scrollable]="true" scrollHeight="400px" rowGroupMode="subheader" groupRowsBy="representative.name" [tableStyle]="{ 'min-width': '60rem' }">
                    ...
                    <ng-template pTemplate="body" let-customer let-rowIndex="rowIndex">
                        <tr>
                            ...
                            <td>
                                <div class="flex items-center gap-2">
                                    <img src="https://primefaces.org/cdn/primeng/images/demo/flag/flag_placeholder.png" [class]="'flag flag-' + customer.country.code" />
        ...
        [tableStyle]="{'min-width': '60rem'}">
            ...
            <ng-template pTemplate="body" let-customer let-rowIndex="rowIndex">
                <tr>
                    ...
                    <td>
                        <div class="flex items-center gap-2">
                            <img src="https://primefaces.org/cdn/primeng/images/demo/flag/flag_placeholder.png" [class]="'flag-' + customer.country.code" >
                            <span class="ml-1 vertical-align-middle">{{customer.country.name}}</span>
                        </div>
                    </td>
                    <td>
