        ...
        <div class="card">
            ...
            <p-table [value]="customers" [scrollable]="true" scrollHeight="400px" styleClass="mt-3">
                <ng-template pTemplate="header">
                    <tr>
                        <th style="min-width:100px" pFrozenColumn>Name</th>
                        <th style="min-width:50px" pFrozenColumn>Id</th>
                        <th style="min-width:100px" >Country</th>
                        <th style="min-width:100px" >Date</th>
                        <th style="min-width:100px" >Company</th>
                        <th style="min-width:100px" >Status</th>
                        <th style="min-width:100px" >Activity</th>
                        <th style="min-width:100px" >Representative</th>
                        <th style="min-width:100px"  alignFrozen="right" pFrozenColumn [frozen]="balanceFrozen">Balance</th>
                    </tr>
                </ng-template>
                <ng-template pTemplate="body" let-customer>
                    <tr>
                        <td pFrozenColumn>{{ customer.name }}</td>
                        <td pFrozenColumn>{{ customer.id }}</td>
