    ...
    template: `
        ...
        <div class="card">
            <div class="flex mb-2 gap-2 justify-end">
                <p-button (onClick)="activeItem = items[0]" [rounded]="true" label="1" styleClass="!w-2 !h-2 !p-0" [outlined]="activeItem !== items[0]" />
                <p-button (onClick)="activeItem = items[1]" [rounded]="true" label="2" styleClass="!w-2 !h-2 !p-0" [outlined]="activeItem !== items[1]" />
                <p-button (onClick)="activeItem = items[2]" [rounded]="true" label="3" styleClass="!w-2 !h-2 !p-0" [outlined]="activeItem !== items[2]" />
            </div>
