        ...
        <div class="card">
            <p-timeline [value]="events" align="alternate" styleClass="customized-timeline">
                <ng-template pTemplate="marker" let-event>
                    <span class="flex !w-2 !h-2 items-center justify-center text-white border-circle z-1 shadow-1" [style]="{ 'background-color': event.color }">
...
export class TemplateDoc {
    ...
    <ng-template pTemplate="marker" let-event>
        <span
            class="flex !w-2 !h-2 items-center justify-center text-white border-circle z-1 shadow-1"
