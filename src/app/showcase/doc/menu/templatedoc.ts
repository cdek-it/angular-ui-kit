...
@Component({
    ...
    template: `
        ...
        <div class="card flex justify-center">
            <p-menu [model]="items" styleClass="w-full md:!w-15">
                ...
                <ng-template pTemplate="end">
                    <button pRipple class="relative overflow-hidden w-full p-link flex items-center p-2 pl-3 text-color hover:surface-200 border-noround">
...
export class TemplateDoc implements OnInit {
    ...
    code: Code = {
        basic: `<p-menu [model]="items" styleClass="w-full md:!w-15">
    <ng-template pTemplate="start">
        <span class="inline-flex items-center gap-1 px-2 py-2">
            <svg width="33" height="35" viewBox="0 0 33 35" fill="none" xmlns="http://www.w3.org/2000/svg" class="block mx-auto">
