    ...
    template: `
        <app-docsectiontext>
            <p>
                ...
                <span class="border-round inline-flex border-1 !w-2 !h-2 p-0 items-center justify-center bg-primary"><span class="pi pi-palette"></span></span> at the topbar to switch themes.
            </p>
        </app-docsectiontext>
