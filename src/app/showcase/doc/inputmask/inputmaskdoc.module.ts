...
import { ClearDoc } from '@doc/inputmask/cleardoc';
...
@NgModule({
    ...
    declarations: [ImportDoc, BasicDoc, ClearDoc, MaskDoc, SlotCharDoc, OptionalDoc, FloatlabelDoc, DisabledDoc, InvalidDoc, StyleDoc, AccessibilityDoc, ReactiveFormsDoc, FilledDoc]
})
