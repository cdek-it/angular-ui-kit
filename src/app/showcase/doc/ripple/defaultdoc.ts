...
@Component({
    ...
    template: `
        ...
        <div class="card card-container flex justify-center items-center">
            <div pRipple class="card text-primary bg-primary flex select-none justify-center items-center shadow-2">Default</div>
        </div>
...
export class DefaultDoc {
    code: Code = {
        basic: `<div pRipple class="card text-primary bg-primary flex select-none justify-center items-center shadow-2">
    Default
</div>`,
        html: `<div class="card card-container flex justify-center items-center">
    <div pRipple class="card text-primary bg-primary flex select-none justify-center items-center shadow-2">
        Default
    </div>
</div>`,
