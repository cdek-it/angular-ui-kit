    ...
    template: `
        ...
        <div class="card flex items-center">
            <p-chip styleClass="pl-0 pr-4">
                <span class="bg-primary text-primary-contrast rounded-full !w-2 !h-2 flex items-center justify-center">P</span>
...
export class TemplateDoc {
    ...
    <span class="bg-primary text-primary-contrast rounded-full !w-2 !h-2 flex items-center justify-center">
        P
    </span>
