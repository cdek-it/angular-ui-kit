    ...
    template: `
        ...
        <div class="card">
            <p-menubar [model]="items" styleClass="template-demo">
                ...
                <ng-template pTemplate="item" let-item let-root="root" let-implicit="implicit">
                    <a pRipple class="flex items-center p-menuitem-link custom-link">
                        ...
                        <i *ngIf="item.items && !isMobile" [ngClass]="['pi', root ? 'pi-angle-down ml-2' : 'pi-angle-right ml-auto']"></i>
                        <i *ngIf="item.items && isMobile" [ngClass]="'pi pi-angle-right ml-auto'"></i>
                    </a>
                </ng-template>
                <ng-template pTemplate="end">
                    <div class="flex items-center gap-2">
                        <input type="text" pInputText placeholder="Search" class="!w-8 sm:w-auto" />
...
export class TemplateDoc implements OnInit {
    ...
    ngOnInit() {
        this.breakpointObserver.observe([Breakpoints.HandsetPortrait, Breakpoints.HandsetLandscape, Breakpoints.Tablet]).subscribe((result) => {
            if (result.matches) {
                this.isMobile = true;
                console.log('Currently in a mobile breakpoint.');
            } else {
                this.isMobile = false;
            }
        });
    ...
    code: Code = {
        ...
        typescript: ` items: MenuItem[] | undefined;
    isMobile = false;
