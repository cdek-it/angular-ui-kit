                ...
                <ng-template pTemplate="content">
                    <div class="grid grid-cols-12 gap-4">
                        <div class="field col-span-12  md:col-span-6">
                            ...
                            <p-dropdown styleClass="w-full" inputId="class" [(ngModel)]="seatInformation.class" [options]="classes" (onChange)="setVagons($event)" optionLabel="name" placeholder="Select a Class"></p-dropdown>
                        </div>
                        <div class="field col-span-12 md:col-span-6">
                            <label for="wagon">Wagon</label>
                            <p-dropdown styleClass="w-full" inputId="wagon" [(ngModel)]="seatInformation.wagon" [options]="vagons" (onChange)="setSeats($event)" optionLabel="wagon" placeholder="Select a Wagon"></p-dropdown>
                        </div>
                        <div class="field col-span-12">
                            <label for="seat">Seat</label>
                            <p-dropdown styleClass="w-full" inputId="seat" [(ngModel)]="seatInformation.seat" [options]="seats" optionLabel="seat" placeholder="Select a Seat"></p-dropdown>
                        </div>
                    </div>
                </ng-template>
                <ng-template pTemplate="footer">
...
@Component({
    template: \`
        <div class="stepsdemo-content">
            <p-card>
                <ng-template pTemplate="title"> Confirmation1 </ng-template>
                <ng-template pTemplate="subtitle"> Please verify the entered data333 </ng-template>
                <ng-template pTemplate="content">
                    <div class="grid grid-cols-12 gap-4">
                        <div class="field col-span-12 md:col-span-6">
                            <span>Name</span>
