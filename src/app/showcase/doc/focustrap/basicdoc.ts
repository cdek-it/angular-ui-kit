...
@Component({
    ...
    template: `
        ...
        <div pFocusTrap class="card flex items-center justify-center flex-wrap gap-3">
            <div>
                <h4>Input</h4>
...
export class BasicDoc {
    ...
    code: Code = {
        basic: `<div pFocusTrap class="card flex items-center justify-center flex-wrap gap-3">
    <div>
        <h4>Input</h4>
        <input id="input" type="text" size="30" pInputText>
    </div>
    <div>
        ...
        html: `<div pFocusTrap class="card flex items-center justify-center flex-wrap gap-3">
    <div>
        <h4>Input</h4>
        <input id="input" type="text" size="30" pInputText>
    </div>
