...
@Component({
    ...
    template: `
        ...
        <div class="card flex justify-center flex-wrap gap-3 items-center">
            ...
            <p-button label="xLarge" icon="pi pi-check" size="xlarge" />
        </div>
...
<p-button label="xLarge" icon="pi pi-check" size="xlarge" />`,
        ...
        html: `<div class="card flex justify-center flex-wrap gap-3 items-center">
    <p-button label="Small" icon="pi pi-check" size="small" />
    <p-button label="Normal" icon="pi pi-check" />
    <p-button label="Large" icon="pi pi-check" size="large" />
    <p-button label="xLarge" icon="pi pi-check" size="xlarge" />
