...
@Component({
    ...
    template: `
        ...
        <div class="card flex flex-wrap gap-3">
            <div class="p-2 border-1 surface-border border-round !w-15 !h-10">
            ...
            <div class="p-2 !w-15 !h-10 drop-column" pDroppable (onDrop)="drop()">
...
export class DropIndicatorDoc {
    ...
    code: Code = {
        basic: `<div class="p-2 border-1 surface-border border-round !w-15 !h-10">
    <ul class="list-none flex flex-col gap-2 p-0 m-0">
        <li
