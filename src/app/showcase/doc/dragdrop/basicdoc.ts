...
@Component({
    ...
    template: `
        ...
        <div class="card flex flex-wrap gap-3">
            <div class="p-2 border-1 surface-border border-round !w-15">
            ...
            <div class="p-2 border-1 surface-border border-round !w-15" pDroppable (onDrop)="drop()">
...
export class BasicDoc implements OnInit {
    ...
    code: Code = {
        basic: `<div class="p-2 border-1 surface-border border-round !w-15">
    <ul class="list-none flex flex-col gap-2 p-0 m-0">
        <li
