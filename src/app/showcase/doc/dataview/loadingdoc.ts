                ...
                <ng-template pTemplate="list" let-products>
                    <div class="grid grid-nogutter">
                        <div class="col-12" *ngFor="let i of counterArray(6); let first = first" class="col-12">
                            <div class="flex flex-col xl:flex-row xl:items-start p-4 gap-4" [ngClass]="{ 'border-top-1 surface-border': !first }">
                                <p-skeleton styleClass="w-9 sm:!w-16 xl:!w-10 !h-6 block xl:block mx-auto border-round" />
                                <div class="flex flex-col sm:flex-row justify-between items-center xl:items-start flex-1 gap-4">
                                    <div class="flex flex-col items-center sm:items-start gap-3">
                                        <p-skeleton styleClass="!w-8 border-round !h-2" />
                                        <p-skeleton styleClass="!w-6 border-round !h-1" />
                                        <div class="flex items-center gap-3">
                                            <p-skeleton styleClass="!w-6 border-round !h-1" />
                                            <p-skeleton styleClass="!w-3 border-round !h-1" />
                                        </div>
                                    </div>
                                    <div class="flex sm:flex-col items-center sm:items-end gap-3 sm:gap-2">
                                        <p-skeleton styleClass="!w-4 border-round !h-2" />
                                        <p-skeleton shape="circle" styleClass="!w-3 !h-3" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 sm:col-6 md:col-4 xl:col-6 p-2" *ngFor="let i of counterArray(6)">
                            <div class="p-4 border-1 surface-border surface-card border-round">
                                <div class="flex flex-wrap items-center justify-between gap-2">
                                    <p-skeleton styleClass="!w-6 border-round !h-2" />
                                    <p-skeleton styleClass="!w-3 border-round !h-1" />
                                </div>
                                <div class="flex flex-col items-center gap-3 py-5">
                                    <p-skeleton styleClass="w-9 border-round !h-10" />
                                    <p-skeleton styleClass="!w-8 border-round !h-2" />
                                    <p-skeleton styleClass="!w-6 border-round !h-1" />
                                </div>
