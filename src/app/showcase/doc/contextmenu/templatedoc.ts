...
@Component({
    ...
    template: `
        ...
        <div class="card flex md:justify-center">
            <ul class="m-0 p-0 list-none border-1 surface-border border-round p-3 flex flex-col gap-2 w-full md:!w-30">
                <li *ngFor="let product of data" class="p-2 hover:surface-hover border-round border-1 border-transparent transition-all transition-duration-200" (contextmenu)="onContextMenu($event)">
                    <div class="flex flex-wrap p-2 items-center gap-3">
                        <img class="!w-4 flex-shrink-0 border-round" src="https://primefaces.org/cdn/primeng/images/demo/product/{{ product.image }}" alt="product.name" />
...
export class TemplateDoc implements OnInit {
    ...
    code: Code = {
        basic: `<ul class="m-0 p-0 list-none border-1 surface-border border-round p-3 flex flex-col gap-2 w-full md:!w-30">
    <li
        *ngFor="let product of data"
        ...
        (contextmenu)="onContextMenu($event)">
            <div class="flex flex-wrap p-2 items-center gap-3">
                <img
                    class="!w-4 flex-shrink-0 border-round"
