...
@Component({
    ...
    template: `
        ...
        <div class="card flex md:justify-center">
            <span #span class="inline-flex items-center justify-center border-2 border-primary border-round !w-4 !h-4" aria-haspopup="true">
...
export class RouterDoc implements OnInit {
    ...
    code: Code = {
        basic: `<span #span class="inline-flex items-center justify-center border-2 border-primary border-round !w-4 !h-4" aria-haspopup="true">
    <svg width="33" height="35" viewBox="0 0 33 35" fill="none" xmlns="http://www.w3.org/2000/svg">
