...
@Component({
    ...
    template: `
        <app-docsectiontext>
            <p>A font icon is displayed as an Avatar with the <i>icon</i> property. It is possible to insert icons from Tabler</p>
        </app-docsectiontext>
        <div class="grid card grid-nogutter">
            <div class="col-12 md:col-4">
                <h5>Icon</h5>
                <p-avatar icon="ti ti-user" styleClass="mr-2" size="xlarge" />
                <p-avatar icon="ti ti-user" styleClass="mr-2" size="large" [style]="{ 'background-color': '#ece9fc', color: '#2a1261' }" />
                <p-avatar icon="ti ti-user" styleClass="mr-2" [style]="{ 'background-color': '#dee9fc', color: '#1a2551' }" />
            </div>
            <div class="col-12 md:col-4">
                <h5>Icon - Circle</h5>
