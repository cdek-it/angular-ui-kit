    ...
    template: `
        ...
        <div class="card">
            <div class="flex mb-3 gap-2 justify-end">
                <p-button (onClick)="activeIndex = 0" rounded="true" label="1" styleClass="!w-2 !h-2 p-0" [outlined]="activeIndex !== 0" />
                <p-button (onClick)="activeIndex = 1" rounded="true" label="2" styleClass="!w-2 !h-2 p-0" [outlined]="activeIndex !== 1" />
                <p-button (onClick)="activeIndex = 2" rounded="true" label="3" styleClass="!w-2 !h-2 p-0" [outlined]="activeIndex !== 2" />
            </div>
...
export class ControlledDoc {
    ...
    code: Code = {
        basic: `<div class="flex mb-3 gap-2 justify-end">
    <p-button
        (click)="activeIndex = 0"
        rounded="true"
        label="1"
        styleClass="!w-2 !h-2 p-0"
