...
@Component({
    ...
    template: `
        <app-docsectiontext>
            ...
            <div class="flex">
                <div class="!h-8 !w-8 flex justify-center items-center mr-5 font-bold bg-blue-600" style="border-radius: 10px;">
                    <span class="text-white">GOOD</span>
                </div>
                <div class="!h-8 !w-8 flex justify-center items-center mr-5 font-bold bg-blue-400" style="border-radius: 10px;">
            ...
            <div class="flex">
                <div class="!h-8 !w-8 flex justify-center items-center mr-5 font-bold bg-pink-500" style="border-radius: 10px;">
            ...
            <div class="flex">
                <div class="!h-8 !w-8 flex flex-col justify-center items-center mr-5 font-bold bg-gray-900" style="border-radius: 10px;">
