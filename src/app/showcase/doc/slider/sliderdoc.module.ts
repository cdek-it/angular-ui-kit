...
import { DisabledDoc } from '@doc/slider/disableddoc';
...
@NgModule({
    ...
    declarations: [ImportDoc, BasicDoc, InputDoc, StepDoc, RangeDoc, VerticalDoc, StyleDoc, AccessibilityDoc, ReactiveFormsDoc, DisabledDoc]
})
