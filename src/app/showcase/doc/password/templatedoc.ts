        ...
        <div class="card flex justify-center">
            <p-password [(ngModel)]="value">
                ...
                <ng-template pTemplate="footer">
                    ...
                    <div class="text-feedback text-feedback--default gap-2 p-1">
                        <i class="ti ti-point text-xl"></i>
                        text feedback
                    </div>

                    <div class="text-feedback text-feedback--success gap-2 p-1">
                        <i class="ti ti-circle-check text-xl"></i>
                        text feedback
                    </div>

                    <div class="text-feedback text-feedback--error gap-2 p-1">
