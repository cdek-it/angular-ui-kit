...
@Component({
    ...
    template: `
        ...
        <div class="card flex justify-center">
            <p-treeSelect class="w-full md:!w-20" containerStyleClass="w-full" [(ngModel)]="selectedNodes" [options]="nodes" display="chip" [metaKeySelection]="false" selectionMode="checkbox" placeholder="Select Item" />
        </div>
