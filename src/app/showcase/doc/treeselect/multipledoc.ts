...
@Component({
    ...
    template: `
        ...
        <div class="card flex justify-center">
            <p-treeSelect class="w-full md:!w-20" containerStyleClass="w-full" [(ngModel)]="selectedNodes" [options]="nodes" [metaKeySelection]="false" selectionMode="multiple" placeholder="Select Item" />
        </div>
