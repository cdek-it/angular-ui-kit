...
@Component({
    ...
    template: `
        ...
        <div class="card flex justify-center">
            <p-treeSelect class="md:!w-20 w-full ng-invalid ng-dirty" containerStyleClass="w-full" [(ngModel)]="selectedNodes" [options]="nodes" placeholder="Select Item" />
        </div>
...
export class InvalidDoc {
    ...
    code: Code = {
        basic: `<p-treeSelect
    class="md:!w-20 w-full ng-invalid ng-dirty"
