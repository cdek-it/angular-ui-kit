...
@Component({
    ...
    template: `
        ...
        <div class="card flex justify-center">
            <p-treeSelect class="md:!w-20 w-full" containerStyleClass="w-full" [(ngModel)]="selectedNodes" [options]="nodes" placeholder="Select Item" [filter]="true" [filterInputAutoFocus]="true" />
        </div>
