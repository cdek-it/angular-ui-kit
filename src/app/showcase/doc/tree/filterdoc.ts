...
@Component({
    ...
    template: `
        ...
        <div class="card flex flex-wrap justify-center gap-5">
            <p-tree [value]="files" class="w-full md:!w-30" [filter]="true" filterPlaceholder="Lenient Filter" />
            <p-tree [value]="files" class="w-full md:!w-30" [filter]="true" filterMode="strict" filterPlaceholder="Strict Filter" />
        </div>
...
<p-tree
    ...
    filterPlaceholder="Strict Filter" />`,
        ...
        html: `<div class="card flex flex-wrap justify-center gap-5">
    <p-tree
        [value]="files"
        class="w-full md:!w-30"
        [filter]="true"
