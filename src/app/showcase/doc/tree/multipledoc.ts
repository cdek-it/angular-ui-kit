...
@Component({
    ...
    template: `
        ...
        <div class="card flex flex-col items-center justify-center">
            ...
            <p-tree [metaKeySelection]="metaKeySelection" [value]="files" class="w-full md:!w-30" selectionMode="multiple" [(selection)]="selectedFiles" />
        </div>
...
export class MultipleDoc implements OnInit {
    ...
    code: Code = {
        basic: `<div class="flex items-center mb-4 gap-2">
    <p-inputSwitch inputId="input-metakey" [(ngModel)]="metaKeySelection" />
    <label for="input-metakey">MetaKey</label>
</div>
<p-tree
