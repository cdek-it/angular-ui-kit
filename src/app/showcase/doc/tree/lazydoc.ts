    ...
    template: `
        ...
        <div class="card flex flex-wrap p-fluid gap-3">
            <div class="flex-auto md:flex md:justify-start md:items-center flex-col">
                ...
                <p-tree class="w-full md:!w-30" [value]="nodes" (onNodeExpand)="onNodeExpand($event)" [loading]="loading" />
            </div>
            <div class="flex-auto md:flex md:justify-start md:items-center flex-col">
                <label for="icon" class="font-bold block mb-2">Icon Mode</label>
                <p-tree class="w-full md:!w-30" [value]="nodes2" loadingMode="icon" (onNodeExpand)="onNodeExpand2($event)" />
            </div>
        </div>
