...
@Component({
    ...
    template: `
        ...
        <div class="card flex justify-center">
            <p-tree class="w-full md:!w-30" scrollHeight="250px" [virtualScroll]="true" [lazy]="true" [virtualScrollItemSize]="46" [value]="files" (onNodeExpand)="nodeExpand($event)" [loading]="loading" />
        </div>
