    ...
    template: `
        ...
        <div class="card flex flex-col items-center">
            ...
            <div class="hidden animation-duration-500 box">
                <div class="flex bg-green-500 text-white items-center justify-center py-3 border-round-md mt-3 font-bold shadow-2 !w-8 !h-8">Content</div>
            </div>
        </div>
...
<div class="hidden animation-duration-500 box">
    <div class="flex bg-green-500 text-white items-center justify-center py-3 border-round-md mt-3 font-bold shadow-2 !w-8 !h-8">
        Content
    </div>
</div>`,
