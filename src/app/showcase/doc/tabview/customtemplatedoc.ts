        ...
        <div class="card">
            <p-tabView styleClass="tabview-custom">
                <p-tabPanel>
                    <ng-template pTemplate="header">
                        <div class="flex flex-row items-center gap-2">
                            <p-avatar class="flex" image="https://primefaces.org/cdn/primeng/images/demo/avatar/amyelsner.png" shape="circle" />
                ...
                <p-tabPanel header="Header II">
                    <ng-template pTemplate="header">
                        <div class="flex flex-row items-center gap-2">
                            <p-avatar class="flex" image="https://primefaces.org/cdn/primeng/images/demo/avatar/onyamalimba.png" shape="circle" />
                ...
                <p-tabPanel header="Header III">
                    <ng-template pTemplate="header">
                        <div class="flex flex-row items-center gap-2">
                            <p-avatar class="flex" image="https://primefaces.org/cdn/primeng/images/demo/avatar/ionibowcher.png" shape="circle" />
