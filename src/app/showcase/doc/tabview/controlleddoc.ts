    ...
    template: `
        ...
        <div class="card">
            <div class="flex mb-2 gap-2 justify-end">
                <p-button (onClick)="activeIndex = 0" rounded="true" styleClass="!w-2 !h-2 !p-0" [outlined]="activeIndex !== 0" label="1" />
                <p-button (onClick)="activeIndex = 1" rounded="true" styleClass="!w-2 !h-2 !p-0" [outlined]="activeIndex !== 1" label="2" />
                <p-button (onClick)="activeIndex = 2" rounded="true" styleClass="!w-2 !h-2 !p-0" [outlined]="activeIndex !== 2" label="3" />
            </div>
