    ...
    template: `
        ...
        <div class="card">
            ...
            <div pDefer (onLoad)="onLoad()">
                <ng-template>
                    <img class="w-full md:!w-30 md:block md:mx-auto" src="https://primefaces.org/cdn/primeng/images/demo/nature/nature1.jpg" alt="Prime" />
                </ng-template>
            </div>
        </div>
...
export class BasicDoc {
    ...
    <ng-template>
        <img
            class="w-full md:!w-30 md:block md:mx-auto"
