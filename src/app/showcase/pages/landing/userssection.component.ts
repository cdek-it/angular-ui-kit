...
@Component({
    ...
    template: `
        <section class="landing-users py-8 px-3 lg:px-8">
            ...
            <div class="logo-section relative w-full md:!w-8/12 mt-6 users-container">
                <div class="fade-left !h-6 !w-6 block absolute top-0 left-0 z-2" style="background: linear-gradient(to right, var(--home-bg), transparent)"></div>
                ...
                <div class="fade-right !h-6 !w-6 block absolute top-0 right-0 z-2" style="background: linear-gradient(to left, var(--home-bg), transparent)"></div>
            </div>
            <div class="logo-section relative w-full md:!w-8/12 mt-2 users-container">
                <div class="fade-left !h-6 !w-6 block absolute top-0 left-0 z-2" style="background: linear-gradient(to right, var(--home-bg), transparent)"></div>
                <div class="marquee-wrapper overflow-hidden flex">
