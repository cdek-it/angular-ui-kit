    ...
    template: `
        <section class="landing-footer pt-8 px-5 lg:px-8">
            <div class="landing-footer-container">
                ...
                <div class="flex flex-wrap justify-between py-6 gap-5">
                    <span>
                    ...
                    <div class="flex items-center gap-2">
                        <a href="https://twitter.com/prime_ng" target="_blank" rel="noopener noreferrer" class="linkbox block !w-3 !h-3 flex items-center justify-center">
                            <i class="pi pi-twitter"></i>
                        </a>
                        <a href="https://github.com/primefaces/primeng" target="_blank" rel="noopener noreferrer" class="linkbox block !w-3 !h-3 flex items-center justify-center">
                            <i class="pi pi-github"></i>
                        </a>
                        <a href="https://discord.gg/gzKFYnpmCY" target="_blank" rel="noopener noreferrer" class="linkbox block !w-3 !h-3 flex items-center justify-center">
                            <i class="pi pi-discord"></i>
                        </a>
                        <a href="https://github.com/orgs/primefaces/discussions" class="linkbox block !w-3 !h-3 flex items-center justify-center">
