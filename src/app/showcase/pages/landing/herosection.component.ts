    ...
    template: `
        <section class="landing-hero py-8 px-5 lg:px-8">
            <div class="flex flex-wrap">
                <div class="w-full xl:!w-6/12 flex flex-col justify-center lg:pr-8 items-center xl:align-items-stretch">
                ...
                <div class="w-full xl:!w-6/12 pt-7 xl:pt-0 hidden md:block">
                    <div class="flex">
                        <div class="flex flex-col !w-6/12 gap-5 pt-8 pr-3">
                            <div class="box p-4 fadein animation-duration-500 z-1">
                                <div class="flex gap-2">
                                    <div class="!w-6 flex-shrink-0">
                                        <span class="text-secondary font-medium block mb-3">Amount</span>
                                        <p-inputNumber [(ngModel)]="value1" mode="currency" currency="USD" locale="en-US" inputStyleClass="lg:!w-6/12 w-full" />
                                    </div>
                        ...
                        <div class="flex flex-col !w-6/12 gap-5 pl-3">
                            <div class="box p-4 fadein animation-duration-500">
                                <div class="surface-card mb-4 w-full text-center p-5" style="border-radius: '10px'">
                                    <img src="https://primefaces.org/cdn/primeng/images/landing/air-jordan.png" alt="Watch" class="!w-14" />
                                </div>
                            ...
                            <div class="box p-4 fadein animation-duration-500">
                                <ul class="list-none p-0 m-0">
                                    <li class="flex items-center mb-3">
                                        <span class="mr-3">
                                            <img src="https://primefaces.org/cdn/primeng/images/landing/avatar.png" alt="Avatar" class="!w-3 !h-3" />
                                        </span>
                                        <div class="flex flex-col">
                                    ...
                                    <li class="flex">
                                        <a class="flex items-center p-3 border-round w-full hover:surface-hover transition-colors transition-duration-150 cursor-pointer" style="border-radius: '10px'">
