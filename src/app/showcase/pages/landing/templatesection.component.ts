...
@Component({
    ...
    template: `
        <section class="landing-templates theme-dark py-8">
            ...
            <div class="flex justify-center mt-4 relative z-3">
                <a href="https://www.primefaces.org/store" class="font-semibold p-3 border-round flex items-center linkbox active" style="z-index: 99">
                    <span>Explore All</span>
                    <i class="pi pi-arrow-right ml-2"></i>
                </a>
            </div>
            <section class="templates templates-animation flex justify-center items-center flex-col mt-7">
                <div class="flex md:flex-row flex-col gap-4 lg:gap-0">
                    <div
                ...
                <div class="flex my-4 md:flex-row flex-col gap-4 lg:gap-0 items-center">
                    <div
