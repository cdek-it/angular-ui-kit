...
| --- | --- | --- |
| `itemSelect` | выбран пункт меню | `(event: MenuItemSelectEvent) => void` |
| `show` | срабатывает при открытии всплывающего меню | `() => void` |
| `hide` | срабатывает при закрытии всплывающего меню | `() => void` |
